...
public class Movie {
	...
	{
		this(name,id); // call the constructor with a string as a parameter, (the one above this one).
	...
	public String toString(){
		...
		return Integer.toString(idMovie) + "::"+ name + "::"+ Double.toString(average)+">>>"+ratingStrings;
	}
	private double getAverage(){		
		return ratings.stream().mapToDouble(Double::doubleValue).average().getAsDouble();
