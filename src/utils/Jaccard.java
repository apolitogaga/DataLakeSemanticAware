...
public class Jaccard {
	...
	public static double jaccardCoeffecient(String s1, String s2) {
...
//		System.out.println("Intersection=" + set1.size());
		...
		jCoeffecient = ((double) set1.size()) / ((double) set2.size());
//		System.out.println("Jaccard coeffecient=" + jCoeffecient);
		return jCoeffecient;
